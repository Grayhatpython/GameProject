...
namespace PacketGenerator
{
    internal class PacketGenerate
    {
        ...
        public void Generate()
        {
            ...
            serverPacketHandler = string.Format(PacketFormat.fileFormat, packetEnums, serverPacketFunction, "ServerPacketHandler", serverPacketRegister, serverMakeSendBuffer);
            clientPacketHandler = string.Format(PacketFormat.fileFormat, packetEnums, clientPacketFunction, "ClientPacketHandler", clientPacketRegister, clientMakeSendBuffer);
        ...
        void ParsePacketEnums()
        {
            ...
            {
                packetEnums += '\t';
                packetEnums += string.Format(PacketFormat.packetEnumFormat, packets[i], packetStartNumber++);
        ...
        void ParseClientPacketHandler()
        {
            ...
            foreach (string packet in clientToServerPacketIds)
            {
                ...
                clientPacketRegister += string.Format(PacketFormat.packetProcessingFunctionRegisterFormat, packet, packet, packet);
        ...
        void ParseServerPacketHandler()
        {
            ...
            foreach (string packet in serverToClientPacketIds)
            {
                ...
                serverPacketRegister += string.Format(PacketFormat.packetProcessingFunctionRegisterFormat, packet, packet, packet);
